/*
 * libssh.cpp - SaSHimi C API entry points
 *
 * This file is part of the SaSHimi Library (Based on SSH Library)
 *
 * Copyright (c) 2003-2013 by Aris Adamantiadis
 * Copyright (c) 2009-2013 by Andreas Schneider <asn@cryptomilk.org>
 * Copyright (c) 2014-2015 by Christophe Grosjean <cgrosjean@wallix.com>
 *
 ...
 *
 * The SaSHimi Library is distributed in the hope that it will be useful, but
